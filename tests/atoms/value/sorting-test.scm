...
(define nlt-stream (SortedValue not-less-relation item-list))
...
(define ngt-stream (SortedValue not-greater-relation item-list))
...
(define gt-stream (SortedValue greater-relation item-list))
