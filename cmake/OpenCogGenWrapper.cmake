...
INCLUDE("${OC_CMAKE_PATH}/cmake/OpenCogGenCxxTypes.cmake")
INCLUDE("${OC_CMAKE_PATH}/cmake/OpenCogGenOCamlTypes.cmake")
INCLUDE("${OC_CMAKE_PATH}/cmake/OpenCogGenPythonTypes.cmake")
INCLUDE("${OC_CMAKE_PATH}/cmake/OpenCogGenScmTypes.cmake")

IF (BUILD_CXX)
	OPENCOG_CXX_ATOMTYPES(
		${SCRIPT_FILE}
		${HEADER_FILE} ${DEFINITIONS_FILE} ${INHERITANCE_FILE})

ELSEIF (BUILD_OCAML)
	OPENCOG_OCAML_ATOMTYPES(${SCRIPT_FILE} ${OCAML_FILE} ${WRAPPER_FILE})
