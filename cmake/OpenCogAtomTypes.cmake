...
ENDMACRO(OPENCOG_CPP_ATOMTYPES)
...
MACRO(OPENCOG_SCM_ATOMTYPES SCM_FILE)
	...
	FOREACH (LINE ${TYPE_SCRIPT_CONTENTS})
		...
		IF (MATCHED AND CMAKE_MATCH_1)
			...
			OPENCOG_TYPEINFO_SETUP()
			OPENCOG_SCM_WRITE_DEFS()    # Print out the scheme definitions
		ELSEIF (NOT MATCHED)
			MESSAGE(FATAL_ERROR "Invalid line in ${SCRIPT_FILE} file: [${LINE}]")
		ENDIF ()
	ENDFOREACH (LINE)
...
MACRO(OPENCOG_PYTHON_ATOMTYPES)
	...
	FOREACH (LINE ${TYPE_SCRIPT_CONTENTS})
		...
		IF (MATCHED AND CMAKE_MATCH_1)
			...
			OPENCOG_TYPEINFO_SETUP()
			OPENCOG_PYTHON_WRITE_DEFS()    # Print out the scheme definitions
		ELSEIF (NOT MATCHED)
			MESSAGE(FATAL_ERROR "Invalid line in ${SCRIPT_FILE} file: [${LINE}]")
		ENDIF ()
	ENDFOREACH (LINE)

ENDMACRO(OPENCOG_PYTHON_ATOMTYPES)
