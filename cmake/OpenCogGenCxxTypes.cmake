...
MACRO(OPENCOG_CXX_WRITE_DEFS)
	...
	# Generate short name ctor if it differs from TYPE_NAME
	# or if it's a custom name
	...
	IF (ISLINK STREQUAL "LINK" AND
		...
		NOT TYPE_NAME STREQUAL "Atom" AND
	...
	# but only if it differs from the custom SHORT_NAME to avoid duplicates.
	IF (HAS_CUSTOM_NAME AND NOT CAMEL_TYPE_NAME STREQUAL "")
		...
		# Only generate if CAMEL_SHORT_NAME differs from the custom SHORT_NAME
		IF (NOT CAMEL_SHORT_NAME STREQUAL SHORT_NAME)
