...
class ZMQSingleTruthValueMessage : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_versionhandle(::ZMQVersionHandleMessage* versionhandle);
...
class ZMQAtomMessage : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_trail(::ZMQTrailMessage* trail);
...
inline void ZMQSingleTruthValueMessage::set_allocated_versionhandle(::ZMQVersionHandleMessage* versionhandle) {
  delete versionhandle_;
  versionhandle_ = versionhandle;
  if (versionhandle) {
    set_has_versionhandle();
  } else {
    clear_has_versionhandle();
...
inline void ZMQAtomMessage::set_allocated_trail(::ZMQTrailMessage* trail) {
  delete trail_;
  trail_ = trail;
  if (trail) {
    set_has_trail();
