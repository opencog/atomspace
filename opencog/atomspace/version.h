...
#define ATOMSPACE_MAJOR_VERSION 6
#define ATOMSPACE_MINOR_VERSION 0
#define ATOMSPACE_MICRO_VERSION 0

#ifndef GIT_COMMIT_HASH
	#define ATOMSPACE_VERSION_STRING "6.0.0"
#else
	#define ATOMSPACE_VERSION_STRING "6.0.0-" GIT_COMMIT_HASH
#endif
