...
struct ImportanceValueChangeEvent {
    ...
    ImportanceValueChangeEvent(const Handle& h,
...
typedef boost::signals2::signal<void (const ImportanceValueChangeEvent&)> ImportanceValueChangedSignal;
...
public:
    ...
    boost::signals2::connection AddAFSignal(
