...
Handle AtomTable::add(AtomPtr atom, bool async)
{
    ...
    // Search again, this isn't much extra work and it lets us reduce
    ...
    // index since we won't have a duplicate due to
    // the critical section above including a search.
