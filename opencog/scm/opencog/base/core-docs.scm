...
"
 cog-new-value TYPE LIST
    ...
    or 'SeqValue. The LIST must be an ordinary guile list, consisting
...
"
 cog-value->list VALUE
    ...
    If VALUE is a StringSeqValue, FloatSeqValue or SeqValue, this returns
