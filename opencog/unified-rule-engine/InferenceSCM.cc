...
#include <opencog/unified-rule-engine/forwardchainer/ForwardChainer.h>
#include <opencog/unified-rule-engine/forwardchainer/DefaultForwardChainerCB.h>
#include <opencog/unified-rule-engine/backwardchainer/BackwardChainer.h>
...
Handle InferenceSCM::do_backward_chaining(Handle h)
{
    ...
    JsonicControlPolicyParamLoader cpolicy_loader(JsonicControlPolicyParamLoader(as, "unified-rule-engine/default_cpolicy.json"));
