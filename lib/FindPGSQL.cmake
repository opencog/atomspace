...
IF (PGSQL_INCLUDE_DIR AND PGSQL_LIBRARY AND KRB5_LIBRARY AND
		GSSAPI_KRB5_LIBRARY AND GSASL_LIBRARY)
	SET(PGSQL_FOUND 1)
...
ELSE (PGSQL_INCLUDE_DIR AND PGSQL_LIBRARY AND KRB5_LIBRARY AND
		GSSAPI_KRB5_LIBRARY AND GSASL_LIBRARY)
	SET(PGSQL_FOUND 0)
	SET(PGSQL_LIBRARIES)
	SET(PGSQL_INCLUDE_DIRS)
ENDIF (PGSQL_INCLUDE_DIR AND PGSQL_LIBRARY AND KRB5_LIBRARY AND
		GSSAPI_KRB5_LIBRARY AND GSASL_LIBRARY)
